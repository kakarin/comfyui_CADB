...
from .nodes_load_vision_gguf import NODE_CLASS_MAPPINGS as LVG_MAP, NODE_DISPLAY_NAME_MAPPINGS as LVG_DISP
...
NODE_CLASS_MAPPINGS.update(LVG_MAP)
...
NODE_DISPLAY_NAME_MAPPINGS.update(LVG_DISP)
